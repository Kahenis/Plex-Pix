...
public final class T0 extends Y1.k implements X1.e {

    /* renamed from: j, reason: collision with root package name */
    public static final H2.T0 f1555j = new H2.T0(2);
    ...
    public final void invoke(I.InterfaceC0155p interfaceC0155p, int i3) {
        ...
        e0.C0393g c0393g = y2.l.f9256c;
        if (c0393g == null) {
            e0.C0391e c0391e = new e0.C0391e("Filled.SkipNext", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 96);
            int i4 = e0.N.f4942a;
            ...
            arrayList.add(new e0.C0378B(6.0f));
            o1Var.h(-2.0f);
            o1Var.d();
